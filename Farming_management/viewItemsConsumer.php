...
<div class="container-fluid px-4" style="min-height: 700px;">
    ...
    ?>
        <ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
            <li class="breadcrumb-item"><a href="viewItemsConsumer.php" style="color: black;text-decoration:none">Dashboard</a></li>
        ...
        <?php
            if(isset($_GET['msg'])){
                ...
                if($_GET['msg'] == 'Order Placed Successfully'){
                    echo '
                        <div class="center">
                                ...
                                foreach($statement->fetchAll() as $row){
                                    echo '
                                        <tr>
                                            ...
                                            <td>
                                                <a href="viewItemsConsumer.php?action=placeOrder&name='.$row['item_name'].'&farmer='.$row['farmer_name'].'&total='.$row['total_item'].'&amount='.$row['amount'].'"><button type="button" name="placeOrder" class="badge bg-danger btn">PLACE ORDER</button></a>
                                            </td>
                                        </tr>
                                    ';
                                }
